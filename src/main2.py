...
#YOU CAN USE THIS MAIN METHOD TO CREATE A TEXTURE FROM THE GIVEN 
#SAMPLES IN THE 'src/Textures' FILE 

if __name__ == '__main__':

    img = cv.imread('src/Textures/texture1.jpeg')
    ...
    plt.axis('off')
    plt.savefig('src/Result/texture1', bbox_inches='tight', pad_inches=0)
    plt.show()
    plt.close()